...
1. 首页不再依赖于外部服务
2. 首页样式优化：自动明暗主题
3. 直链缩短：github、raw、gist、nightly 等同于 https://github.com 、 https://raw.githubusercontent.com 、 https://gist.githubusercontent.com 、 https://nightly.link
4. 简单的代理次数、代理流量统计
...
8. 支持Docker加速：需要定义`hub`子域名
9. Dockerfile适用于部署在northflank平台，可备份配置及统计数据
